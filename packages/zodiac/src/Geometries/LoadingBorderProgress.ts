...
class LoadingBorderProgress {
  ...
  setBorder() {
    const { width, height, thickness } = this.parameters;
    ...
    const innerWidth = outerWidth - thickness
    const innerHeight = outerHeight - thickness
...
export default LoadingBorderProgress
